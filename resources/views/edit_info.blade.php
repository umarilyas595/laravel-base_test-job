                ...
                <div class="form-container">
                    <form method="post" action="{{ route('add.info.form.submit') }}">
                        ...
                        <div class="row">
                            ...
                            <input type="text" class="inputText" id="name" name="name" value="{{ old('name',$data->name) }}">
                        ...
                        <div class="row">
                            <div class="col-md-6 form-group">
                                ...
                                <input type="text" class="inputText" id="phone" name="phone" value="{{ old('phone',$data->phone) }}">
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <input type="text" class="inputText" id="postal_code" name="postal_code" value="{{ old('postal_code',$data->postal_code) }}">
                        ...
                        <div class="row">
                            <div class="col-md-12 form-group">
                                ...
                                <input type="text" class="inputText" id="salary" name="salary" value="{{ old('salary',$data->salary) }}">
